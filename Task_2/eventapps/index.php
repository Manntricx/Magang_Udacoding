      ...
      <?php
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-lg">
                <div class="card-body">
                    <div class="card-title"><h3 class="text-center"></h3><?php echo $row['event_name'] ?></div>
                    <p class="card-text">
                    ><?php echo substr($row['event_description'],0,100) ?>...
                    </p>
                    <a href="detail.php?detail=<?php echo $row['id'] ?>" class="btn btn-danger btn-block" class="nav-link">
